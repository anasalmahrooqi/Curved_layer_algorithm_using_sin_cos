    ...
    for y1 in range(0, yFactor):
        ...
        for x1 in range(0, xFactor):
            ...
            if (Y1>(yFactor/2)):
                Y1 = yFactor-Y1
            print(x1)
            f = 13*((NoOfLayers+1)/Layers)*math.sin((3.14-3.14*0.145)-(3.14-3.14*0.145*2)*((Y1)/(yFactor-1)))
            z1 = (13)*((NoOfLayers+1)/Layers)*math.sin((3.14-3.14*0.145)-(3.14-3.14*0.145*2)*((x1)/(xFactor-1)))
            # print(z1)
...
for line in lines:
    ...
    for px0,py0,pz0,px1,py1,pz1 in line:
        ...
        # print(pz1 - pz0)
        # E += ((4*layerHeight*1.2*d ist)/(3.14*0.4))/(3.14*1.75*1.75/4))
