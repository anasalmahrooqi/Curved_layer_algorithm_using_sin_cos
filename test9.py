    ...
    for y1 in range(0, yFactor):
        ...
        for x1 in range(0, xFactor):
            ...
            if (Y1>(yFactor/2)):
                Y1 = yFactor-Y1
            print(x1)
            f = 15*((NoOfLayers+1)/Layers)*math.sin((3.14-3.14*0.145)-(3.14-3.14*0.145*2)*((Y1)/(yFactor-1)))
            z1 = (15*f/(yFactor/2))*((NoOfLayers+1)/Layers)*math.sin((3.14-3.14*0.145)-(3.14-3.14*0.145*2)*((x1)/(xFactor-1)))
            # print(z1)
...
for line in lines:
    ...
    for px0,py0,pz0,px1,py1,pz1 in line:
        ...
        area = (0.5 - zdis) * zdis + math.pi * (zdis / 2) ** 2
        E1 += (area * dist * 4) / (math.pi * 1.75 * 1.2)
